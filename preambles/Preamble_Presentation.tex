...
\newcommand{\showsectionnavigation}{1}
...
% tche:
\newcommand{\thepapername}{NULL}
\newcommand{\currentpaper}[2][https://scholar.google.com]{%
  \ifx&#2&
    \renewcommand{\thepapername}{}
  \else
    \renewcommand{\thepapername}{%
      \href{#1}{\citealp{#2}}: \citetitle{#2}
    }
  \fi
}

\newenvironment<>{figureblock}[1]{%
  \def\insertblocktitle{#1}%
  \begin{mdframed}[linecolor=SpotColor, linewidth=0.35pt, leftmargin=0pt, innerleftmargin=0.375em, innerrightmargin=0.375em, innertopmargin=-0.01ex, innerbottommargin=4pt]%
    ...
    \renewcommand{\insertblocktitle}{%
 	...
 	{
      \setbeamercolor*{block title}{fg=white, bg=SpotColor}%
...
\input{preambles/Preamble_Fonts_Charter_FiraSans}
...
\input{preambles/Preamble_Sansserif_math}
...
\BeforeBeginEnvironment{frame}{%
	...
	\setbeamertemplate{footline}{\vskip-15pt%
		...
		%tche: \textmd{\insertshortauthor: \enquote{\insertshorttitle}}
        \thepapername
		\hfill%
...
% tche:
% \newcommand{\titleprefix}{\insertsection-{\frameinsection}}
\newcommand{\titleprefix}{\insertsectionhead-{\frameinsection}}
% <==
...
\newcommand{\PutBorderAroundBlock}[2]{
 	...
 	\addtobeamertemplate{block begin}{%
        ...
        \ifx\@currenvir\@minipage
          \begin{mdframed}[linecolor=\framedblockcolor, linewidth=0.35pt, leftmargin=0pt, innerleftmargin=0.375em, innerrightmargin=0.375em, innertopmargin=-2.00ex, innerbottommargin=4pt]%
        \else
...
\input{preambles/Preamble_BibLaTeX_AER}
...
\renewbibmacro*{pageref}{%
	...
	{}
	{\color{UBonnGray}%
		%tche: \printtext[brackets]{\caps{PDF}~%
		\printtext[brackets]{\textscale{0.96}{\textls[35]{Goto}}~%
